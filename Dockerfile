...
COPY ["CustomerAPI.Dal/CustomerAPI.Dal.csproj", "CustomerAPI.Dal/"]
COPY ["CustomerAPI.Entities/CustomerAPI.Entities.csproj", "CustomerAPI.Entities/"]
COPY ["CustomerAPI.Utilities/CustomerAPI.Utilities.csproj", "CustomerAPI.Utilities/"]
COPY ["CustomerAPI.Models/CustomerAPI.Models.csproj", "CustomerAPI.Models/"]
